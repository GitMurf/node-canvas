...
Context2d::Initialize(Napi::Env& env, Napi::Object& target) {
  ...
  Napi::Function ctor = DefineClass(env, "CanvasRenderingContext2D", {
    ...
    InstanceMethod("addPage", &Context2d::AddPage),
    ...
    InstanceMethod("_setFont", &Context2d::SetFont),
    InstanceMethod("_setFillColor", &Context2d::SetFillColor),
    InstanceMethod("_setStrokeColor", &Context2d::SetStrokeColor),
    InstanceMethod("_setFillPattern", &Context2d::SetFillPattern),
    InstanceMethod("_setStrokePattern", &Context2d::SetStrokePattern),
    InstanceMethod("_setTextBaseline", &Context2d::SetTextBaseline),
    InstanceMethod("_setTextAlignment", &Context2d::SetTextAlignment),
    InstanceAccessor("patternQuality", &Context2d::GetPatternQuality, &Context2d::SetPatternQuality),
    ...
    InstanceAccessor("fillColor", &Context2d::GetFillColor, nullptr),
    InstanceAccessor("strokeColor", &Context2d::GetStrokeColor, nullptr),
    ...
    InstanceAccessor("antialias", &Context2d::GetAntiAlias, &Context2d::SetAntiAlias),
    InstanceAccessor("textDrawingMode", &Context2d::GetTextDrawingMode, &Context2d::SetTextDrawingMode),
    InstanceAccessor("filter", &Context2d::GetFilter, &Context2d::SetFilter),
  });
